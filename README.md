<p align="center">
  <img src="insayt.png" alt="Insayt" width="200" />
</p>

<h1 align="center">Insayt</h1>
...
This starts ClickHouse and Insayt together. Open `http://localhost:3002` for the dashboard.
...
If you prefer to add Insayt to your existing Express app instead of running the standalone server:
...
```html
<script src="https://your-server.com/insayt.js"></script>
<script>
...
| Package | Description |
|---------|-------------|
| [`@insayt/core`](./packages/core) | Shared types and constants |
| [`@insayt/tracker`](./packages/tracker) | Browser tracker (~3KB gzipped) |
| [`@insayt/node`](./packages/node) | Server collector, ClickHouse/MongoDB adapters, query API |
| [`@insayt/react`](./packages/react) | React provider and hooks |
| [`@insayt/react-native`](./packages/react-native) | React Native / Expo provider |
| [`@insayt/client`](./packages/client) | Typed client for reading analytics data |
| [`@insayt/dashboard`](./apps/dashboard) | Analytics dashboard (React + Vite + Tailwind) |
| [`@insayt/server`](./apps/server) | Self-hosted server (serves dashboard + API) |
