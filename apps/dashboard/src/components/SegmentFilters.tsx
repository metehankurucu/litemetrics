...
const FILTER_OPTIONS: { key: string; label: string; placeholder?: string }[] = [
  ...
  { key: 'device.os', label: 'OS', placeholder: 'macOS, Windows, iOS...' },
  { key: 'device.osVersion', label: 'OS Version', placeholder: '17.2, 14...' },
  { key: 'device.deviceModel', label: 'Device Model', placeholder: 'Pixel 8, SM-S911B...' },
  { key: 'device.deviceBrand', label: 'Device Brand', placeholder: 'Apple, Samsung...' },
  { key: 'device.appVersion', label: 'App Version', placeholder: '1.2.3' },
