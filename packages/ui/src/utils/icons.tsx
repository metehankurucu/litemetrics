...
export function getBrowserIcon(browser: string): React.ReactNode {
  ...
  return (
    <svg className={`${iconClass} text-[rgb(var(--lm-text-tertiary))]`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function getDeviceIcon(type: string): React.ReactNode {
  ...
  if (t.includes('mobile')) return (
    <svg className={`${iconClass} text-[rgb(var(--lm-text-secondary))]`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function getUtmMediumIcon(medium: string): React.ReactNode {
  ...
  const cls = `${iconClass} text-[rgb(var(--lm-text-secondary))]`;
